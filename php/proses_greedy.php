    ...
    <div class="container">
      ...
      <div class="row center">
          <div class="row">
              <?php
              $nama=$_POST ['name'];
              echo "<form class='cols12' action='hasil_greedy.php' method='post'>";
              $i=0;
              do {
                ...
                //   echo "<input type='text' name='harga$i' placeholder='harga(kubik) $i'>";
                  ...
                  echo "</div>";
                  echo "<div class='input-field col s12'>";
                    echo "<input type='number' name='berat$i' class='validate' required>";
                    echo "<label for='name'>Berat Barang $i</label>";
                  echo "</div>";
                  echo "<div class='input-field col s12'>";
                    echo "<input type='number' name='harga$i' class='validate' required>";
